...
# 🎬 CineLib - Film Eleştiri ve Yorumlama Uygulaması

CineLib, film severler için geliştirilmiş kapsamlı bir mobil uygulamadır. TMDB API entegrasyonu ile güncel film bilgilerine erişim sağlar, Firebase ile kullanıcı yönetimi ve sosyal özellikler sunar.

## 📺 Uygulama Tanıtım Videosu

Uygulamanın kullanımını ve özelliklerini aşağıdaki videodan izleyebilirsiniz: https://youtu.be/Q33llAaMB2E

## ✨ Özellikler

### 🎯 Temel Özellikler

* **Film Keşfi**: TMDB API üzerinden güncel film bilgileri
* **Kategoriye Göre Listeleme**: Netflix tarzı yatay kaydırmalı kategoriler
* **Detaylı Film Bilgileri**: Film özetleri, fragmanlar ve kullanıcı yorumları
* **Kitaptan Uyarlamalar**: Lord of the Rings, Dune, Harry Potter gibi kült eserlere özel bölüm
* **Arama**: Film ve kullanıcı arama özellikleri
...
* **Yorumlar ve İncelemeler**: Filmler için yorum yapma ve spoiler uyarısı
* **Favoriler ve İzleme Listesi**: Kişisel film koleksiyonu oluşturma
...
* [Flutter](https://flutter.dev/) - Framework desteği için

---

**Not**: Bu uygulama TMDB API kullanır ancak TMDB tarafından resmi olarak onaylanmamış veya sertifikalandırılmamıştır.
